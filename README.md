...
3. Once Node.js is installed, open a terminal and type 
```
node -v
```
 to verify that it is installed correctly.
4. npm is included with Node.js, so you don't need to install it separately. However, you can verify that npm is installed by typing 
```
npm -v
``` 
   in the terminal.
...
3. Type 
```
ssh -i "your key path" "username"@"ip address of compute instance"
```
   to connect your instance through CLI.
...
npm run dev 
```
   and press enter. This will launch the development server and open your browser to a new tab with your React application running.

## Deploying the React Application
1. Build your React application by typing 
```
npm run build 
```
   in the terminal. This will create a minified version of your application in the build folder.
...
npm run preview
``` 
   and press enter. This will launch the production server and open your browser to a new tab with your React application running.
...
``` 
   to continuously run this database server for your React application to work.
...
pm2 proxy-server.js
```
   to continuously run this proxy server for your React application to enable the API to work.
